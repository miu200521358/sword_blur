...
刀を動かした時に出るブレの設定をモデルに追加できるツールです
...
　・Readme.txt                  …  Readme
　・content_tree.txt            …  MME等よく使われるツールのコンテンツツリー一覧
　・Community Link - miu's Lab  …  コミュニティへのショートカットリンク
...
　・ニコニコ動画の場合、コンテンツツリーへツリー用静画（im11486697）を登録してください
