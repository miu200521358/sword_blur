...
func TestSave01(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/017_数珠丸恒次/数珠丸恒次 hzeo式/数珠丸恒次（本体）.pmx")
	if err != nil {
	...
	rootVertexIndexes := []int{143, 1770}
	tipVertexIndexes := []int{0, 1734}
...
func TestSave02(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/093_陸奥守吉行/陸奥守吉行 むつ式 ver.2.0/むつ式むっちゃん刀.pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	rootVertexIndexes := []int{164}
	tipVertexIndexes := []int{197}
...
func TestSave03(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/079_江雪左文字/江雪左文字 AKI式 ver.1.51/江雪左文字本体/江雪左文字本体.pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	blurMaterialIndexes := []int{3}
	rootVertexIndexes := []int{876, 993, 994, 1417}
	tipVertexIndexes := []int{1126, 1127, 1186, 1163, 1466}
...
func TestSave04(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/118_へし切長谷部/へし切長谷部 ｻｸﾗｺ式 ver1.20/長谷部本体(鞘無し).pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	rootVertexIndexes := []int{1137, 1128, 1129}
	tipVertexIndexes := []int{944, 1104, 1209}
...
func TestSave05(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/132_太郎太刀/太郎太刀 AKI式 ver.1.00/太郎太刀本体/太郎太刀本体.pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	rootVertexIndexes := []int{127}
	tipVertexIndexes := []int{194}
...
func TestSave06(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/118_へし切長谷部/へし切長谷部 026式 ver.1.57/(3)圧し切長谷部_本体/(3)抜刀ver.1.10.pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	rootVertexIndexes := []int{1376, 1596}
	tipVertexIndexes := []int{1108, 1138}
...
func TestSave07(t *testing.T) {
	...
	data, err := pmxRep.Load("D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/097_山伏国広/山伏国広ver0_57 ぴえ式/本体.pmx")
	if err != nil {
		t.Errorf("Expected error to be nil, got %q", err)
	}
	originalModel := data.(*pmx.PmxModel)
	...
	blurMaterialIndexes := []int{1}
	rootVertexIndexes := []int{6, 5}
	tipVertexIndexes := []int{45, 82, 105, 107}
